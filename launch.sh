...
#aws rds create-db-instance --db-name Project1 --publicly-accessible --db-instance-identifier db1 --db-instance-class db.t2.micro --engine MySQL --allocated-storage 5 --master-username testconnection1 --master-user-password testconnection1 --db-subnet-group-name subnetgrp1test
